...
with tab1:
    ...
    if master_df is not None:
        try:
            ...
            # 🎯 HARDENED ALIGNMENT LAYER (Directly targets fields generated by office_exporter.py)
            # Use assignment fallbacks that return clean Series objects instead of raw float numbers to prevent crashes
            ...
            # Extracting px_bid.1 and px_ask.1 keys generated by office_exporter.py cleanly
            ...
            if not df_metal.empty:
                ...
                with st.expander("🔍 View Raw Ingestion Ledger Data"):
                    ...
                    # Convert Datetime variables into clean text format for the UI
